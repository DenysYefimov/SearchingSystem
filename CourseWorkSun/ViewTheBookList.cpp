...
void ViewTheBookList(HANDLE output_handle, CONSOLE_SCREEN_BUFFER_INFO& CSBufInf, int INACTIVE_COLOUR, int ACTIVE_COLOUR)
{
	...
	COORD interval = { (CSBufInf.srWindow.Right / 2) - 9, (CSBufInf.srWindow.Bottom / 2) - 7 }, library{ (CSBufInf.srWindow.Right / 2) - 3, (CSBufInf.srWindow.Bottom / 2) - 10 }, frame{ (CSBufInf.srWindow.Right / 2) - 11, (CSBufInf.srWindow.Bottom / 2) - 8 }, output{10, 8};
